...
const npmSearchLogic = createLogic({
  ...
  processOptions: {
    successType: NPM_SEARCH_FULFILLED, // apply action type for success
    failType: NPM_SEARCH_REJECTED // apply action type for failures
  },

  process({ getState, action }) {
    return axios.get(`https://npmsearch.com/query?q=${action.payload}&fields=name,description`)
