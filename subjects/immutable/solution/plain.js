...
describe('immutable/plain', () => {
  ...
  /*
     TODO 1a. In an immutable fashion create a new struct `struct2`
     which is a clone of struct1 and updates the firstName to 'Jessica'
     without using ImmutableJS or any helper libs. Hint: you might use
  ...
  /*
     TODO 1b. In an immutable fashion create a new struct `struct3`
  ...
  beforeEach('clone struct3 from struct2, append email jb@foo.com', () => {
    ...
    struct3 = {
      ...
      profile: {
        ...struct2.profile,
        emails: struct2.profile.emails.concat('jb@foo.com')
      }
    };
  });

  it('struct3 should still have profile.firstName = Jessica', () => {
    // TODO 1c access firstName from struct3
  ...
  /*
     TODO 1e. Create an array of states called `history` which
