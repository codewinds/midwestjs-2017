...
describe('immutable/lodash-fp', () => {
  ...
  /*
     TODO 6a. Use lodash/fp lib to create struct2 as
  ...
  /*
     TODO 6b. Create struct3 cloning struct2 appending new email
     `jb@foo.com`
   */
  ...
  /*
     TODO 6e. Create an array of states called `history` which
